...
void InsertNth(struct Node ** head_ref)
{
    int new_data, index, i = 0;
    printf("Enter the the number to insert into the list and the index at which to insert it : ");
    scanf("%d %d", &new_data, &index);
...
int main()
{
    ...
    do
    {
        ...
        printf("Press 2 to insert an element at any index in the list\n");
